                ...
                <div className="px-6 py-12 text-center md:px-12 lg:text-left">
                    ...
                    <div className="grid items-center lg:grid-cols-2">
                        ...
                        <div
                            ...
                            Innovación a precios insuperables <br /><span className="text-primary"></span>
                            </h1>
                            ...
                            data-te-ripple-init data-te-ripple-color="light" href="#!" role="button">Ver Productos</a>
                            ...
                            data-te-ripple-init data-te-ripple-color="light" href="#!" role="button">Sobre Nosotros</a>
                        </div>
                        </div>
                        <div className="md:mb-12 lg:mb-0">
                        <img src="https://photos5.appleinsider.com/gallery/55901-113522-iOS-17-Beta-6-xl.jpg"
